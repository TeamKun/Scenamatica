        ...
        implements Executable<EntityPickupItemAction.Argument>, Watchable<EntityPickupItemAction.Argument>
{
    ...
    public static class Argument extends AbstractEntityActionArgument
    {
        ...
        public Argument(@Nullable Object mayTarget, Integer remaining, EntityItemBean item)
        {
            super(mayTarget);
        ...
        public Argument(@Nullable Object mayTarget, Integer remaining, String itemSelector)
        {
            super(mayTarget);
            this.remaining = remaining;
            this.item = null;
