...
public class HumanEntityStructureImpl extends GenericHumanEntityStructureImpl implements HumanEntityStructure
{
    ...
    public HumanEntityStructureImpl(GenericHumanEntityStructure original)
    {
        super(original);
    }

    public HumanEntityStructureImpl(GenericEntityStructure original, PlayerInventoryStructure inventory, InventoryStructure enderChest, MainHand mainHand, GameMode gamemode, Integer foodLevel)
    {
