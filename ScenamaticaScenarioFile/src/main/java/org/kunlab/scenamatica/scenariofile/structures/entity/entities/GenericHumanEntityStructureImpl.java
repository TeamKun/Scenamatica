...
@Data
@AllArgsConstructor
public class GenericHumanEntityStructureImpl extends GenericEntityStructureImpl implements GenericHumanEntityStructure
{
    ...
    public GenericHumanEntityStructureImpl(Location location, Vector velocity, String customName, UUID uuid, Boolean glowing,
    ...
    public GenericHumanEntityStructureImpl(GenericHumanEntityStructure original)
    {
        this(
                original,
    ...
    public GenericHumanEntityStructureImpl(
            GenericEntityStructure original,
     ...
     */
    @NotNull
    public static Map<String, Object> serializeHuman(@NotNull GenericHumanEntityStructure structure, @NotNull StructureSerializer serializer)
    {
     ...
     */
    @NotNull
    public static GenericHumanEntityStructure deserializeHuman(@NotNull Map<String, Object> map, @NotNull StructureSerializer serializer)
    {
        validate(map);

        GenericEntityStructure entityStructure = GenericEntityStructureImpl.deserialize(map, serializer);
        ...
        return new GenericHumanEntityStructureImpl(
                entityStructure,
                inventory,
                enderChest,
                mainHand,
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof GenericHumanEntityStructureImpl)) return false;
        if (!super.equals(o)) return false;
        GenericHumanEntityStructureImpl that = (GenericHumanEntityStructureImpl) o;
