...
@Data
@AllArgsConstructor
public class GenericEntityStructureImpl implements GenericEntityStructure
{
    ...
    protected GenericEntityStructureImpl()
    {
        this(
                null,
                null,
    ...
    protected GenericEntityStructureImpl(@NotNull GenericEntityStructure original)
    {
        this(
                original.getType(),
    ...
    protected GenericEntityStructureImpl(@NotNull EntityType type, @NotNull GenericEntityStructure original)
    {
        this(
                type,
                original.getLocation(),
     ...
     */
    @NotNull
    public static Map<String, Object> serialize(@NotNull GenericEntityStructure entity, @NotNull StructureSerializer serializer)
    {
    ...
    public static GenericEntityStructure deserialize(@NotNull Map<String, Object> map, @NotNull StructureSerializer serializer)
    {
        validate(map);
        ...
        return new GenericEntityStructureImpl(
                type,
                loc,
                velocity,
                customName,
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof GenericEntityStructureImpl)) return false;
        GenericEntityStructureImpl that = (GenericEntityStructureImpl) o;
