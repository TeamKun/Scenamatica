...
public class ItemStackStructureSerializeTest
{
    ...
    void 正常シリアライズできるか()
    {
        Map<String, Object> actual = ItemStackStructureImpl.serialize(FULFILLED, StructureSerializerImpl.getInstance());
    ...
    {
        Map<String, Object> actual = ItemStackStructureImpl.serialize(EMPTY, StructureSerializerImpl.getInstance());
    ...
    {
        Map<String, Object> actual = ItemStackStructureImpl.serialize(ONLY_ONE_ITEM, StructureSerializerImpl.getInstance());
