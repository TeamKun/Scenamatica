...
public class ResultKeys
{
    ...
    public static final String KEY_PLUGIN_VERSION = "version";
    public static final String KEY_PLUGIN_AUTHORS = "authors";
    public static final String KEY_PLUGIN_AUTHOR = "author";
    public static final String KEY_PLUGIN_DESCRIPTION = "description";
    public static final String KEY_PLUGIN_URL = "url";
    public static final String KEY_PLUGIN_WEBSITE = "website";
