...
プレイヤ指定子は、文字列型と[Player 型](/docs/use/scenario/types/entities#player-structure)としてふるまう特別な型です。

基本的には上記の[エンティティ指定子](#entity-specifier)と同じですが、プレイヤを指定する場合にのみ有効です。

---

## 特別： EntityType 列挙型 {#entity-type-enum}
...
<Object objects={[
  {
    name: "type",
    type: "EntityType",
    type_link: "/docs/use/scenario/types/entities#entity-type-enum",
