...
+ [Entity 型](../types#entity-structure) のオブジェクト  
...
アクション実行シナリオの場合でも, [アイテムの構造体](../types#entity-item-structure)またはエンティティのセレクタを指定できます。
...
<Action name="エンティティの設置"
        ...
        args={[
          ...
          },
          {
            ...
            type_link: "../types#block-face-enum",
...
アクション実行シナリオの場合、この項目および [`Block#location`](../types#location-structure) は必須です。
