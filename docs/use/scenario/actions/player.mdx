...
<Action name="バケツの使用"
        ...
        args={[
          ...
          },
          {
            ...
            type: "Block",
            type_link: "../../types#block-structure",
          },
          {
            name: "clickedBlock",
            description: "バケツを使用するブロックです。",
...
進捗を [`NamespacedKey`](../types#namespaced-key-structure) で指定します。
...
<Action name="プレイヤによるエンティティのバケツへの格納"
        ...
        args={[
          ...
          },
          {
            ...
            type: "Entity",
            type_link: "../../types#entity-structure",
          },
          {
            name: "bucket",
            description: "エンティティを入れるバケツです。",
            type: "ItemStack",
            type_link: "../../types#item-stack-structure",
          },
          {
            name: "entityBucket",
...
<Action name="アイテムのドロップ"
        ...
        args={[
          ...
          },
          {
            ...
            type: "EntityItem",
            type_link: "../types#entity-item-structure",
          }
        ]}
        executable watchable
/>
...
この型は[こちら](../types/#item-stack-structure)を参照してください。

## プレイヤのエンティティのクリック（作用） {#interact-at-entity}
        ...
        args={[
          {
            name: "target",
            type: ObjectType.STRING,
            type_anchor: "entity/#general-entity",
          ...
          },
          {
            ...
            type_link: "../types#location-structure",
...
## プレイヤのエンティティのクリック {#interact-entity}
