...
対象となったプレイヤの [`Player`](/docs/use/scenario/types/README#actor-structure) オブジェクトを出力します。
...
<Action name="バケツの使用"
        ...
        outputs={[
          {
            name: "target",
            description: "バケツを使用したプレイヤーです。",
            type: "Player",
            type_link: "/docs/use/scenario/types/README#actor-structure",
          },
          {
            name: "item",
        ...
        outputs={[
          {
            name: "target",
            anchor: "target",
            description: "アニメーションを実行したプレイヤーです。",
            type: "Player",
            type_link: "/docs/use/scenario/types/README#actor-structure",
          },
          {
        ...
        outputs={[
          {
            name: "target",
            anchor: "target",
            description: "アイテムをドロップしたプレイヤーです。",
            type: "Player",
            type_link: "/docs/use/scenario/types/README#actor-structure",
          },
          {
...
+ アクション実行シナリオでは、ドロップしたアイテムの [`ItemStack`](/docs/use/scenario/types/inventory-items/#item-stack-structure) が出力されます。
+ 実行期待シナリオでは、ドロップしたアイテムの [`EntityItem`](/docs/use/scenario/types/entities#entity-item-structure) が出力されます。
:::
        ...
        outputs={[
          {
            name: "target",
            anchor: "target",
            description: "ゲームモードを変更したプレイヤーです。",
            type: "Player",
            type_link: "/docs/use/scenario/types/README#actor-structure",
          },
          {
...
<Action name="ホットバーのスロットの変更"
        ...
        outputs={[
          {
            name: "target",
            description: "ホットバーのスロットを変更したプレイヤーです。",
            type: "Player",
            type_link: "/docs/use/scenario/types/README#actor-structure",
          },
          {
          ...
          },
          {
            ...
            description: "変更前のホットバーのスロットです。",
            type: ObjectType.INTEGER,
            available: [ScenarioType.EXPECT, ScenarioType.EXECUTE]
          },
          {
            name: "item",
            description: "ホットバーのスロットにあるアイテムです。",
...
<Action name="プレイヤのエンティティの相互作用"
        ...
        outputs={[
          ...
          },
          {
            name: "entity",
            type: "Entity",
            type_link: "/docs/use/scenario/types/entities#entity-structure",
            description: "クリックした対象のエンティティです。",
          },
          {
            name: "hand",
        ...
        outputs={[
          {
            name: "target",
            anchor: "target",
            description: "ブロックをクリックしたプレイヤーです。",
            type: "Player",
            type_link: "/docs/use/scenario/types/README#actor-structure",
          },
          {
        ...
        outputs={[
          {
            name: "target",
            anchor: "target",
            description: "破壊されたアイテムを持っているプレイヤーです。",
            type: "Player",
            type_link: "/docs/use/scenario/types/README#actor-structure",
          },
          {
        ...
        outputs={[
          {
            name: "target",
            type: "Player",
            type_link: "/docs/use/scenario/types#actor-structure",
            description: "経験レベルを変更したプレイヤーです。",
          },
          {
            name: "level",
            description: "新しい経験レベルです。",
