...
<Action name="バケツの使用"
        ...
        args={[
          ...
          },
          {
            ...
            type: "Block",
            type_link: "/docs/use/scenario/types#block-structure",
          },
          {
            name: "clickedBlock",
            description: "バケツを使用するブロックです。",
...
進捗を [`NamespacedKey`](/docs/use/scenario/types#namespaced-key-structure) で指定します。
...
<Action name="プレイヤのエンティティのクリック（作用）"
        ...
        args={[
          ...
          },
          {
            ...
            type_link: "/docs/use/scenario/types#location-structure",
