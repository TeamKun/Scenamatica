...
これらのアクションは、[NamespacedKey](/docs/use/scenario/types/misc#namespaced-key-structure) 型のオプション引数 `world` を受け取ります。
...
**[条件要求(`require`)](/docs/use/scenario/elements#scenario-type-condition-require) でのみ使用できます。**
