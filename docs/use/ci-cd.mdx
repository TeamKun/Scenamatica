...
steps:
  ...
  - name: Run tests with Scenamatica
    ...
    with:
      scenamatica: 0.5.2 # 新しい Scenamatica のバージョンがリリースされた場合は、ここを更新してください。
...
| 名前            | 説明                             | 必須  | デフォルト値   | 摘要                                                         |
|:--------------|:-------------------------------|:----|:---------|:-----------------------------------------------------------|
| `scenamatica` | Scenamatica のバージョンを指定します。      | はい  | `N/A`    | Scenamatica のバージョンを指定します。新しいバージョンがリリースされた場合は、この値を更新してください。 |
