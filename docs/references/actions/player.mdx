...
対象のエンティティを[PlayerSpecifier 型（プレイヤ指定子）](/references/types/entities#player-specifier)で指定します。
...
対象となったプレイヤの [`Player`](/references/types/entities/#player) オブジェクトを出力します。
...
<Action name="プレイヤ"
        ...
        args={[
          ...
          },
          {
            name: "data",
            type: "Player",
            type_link: "/references/types#player",
...
<Action name="バケツの使用"
        ...
        args={[
          ...
          },
          {
            ...
            type: "Block",
            type_link: "/references/types/misc#block",
          },
          {
            name: "clickedBlock",
            description: "バケツを使用するブロックです。",
          ...
          },
          {
            ...
            description: "使用する手です。",
            type: "Hand",
            type_link: "/references/types/entities#hand",
            default: "MAIN_HAND",
        ...
        outputs={[
          ...
          },
          {
            ...
            type: "ItemStack",
            type_link: "/references/types#item-stack",
          },
          {
            name: "bucket",
...
進捗を [`NamespacedKey`](/references/types/misc#namespaced-key) で指定します。
...
<Action name="プレイヤによるエンティティのバケツへの格納"
        ...
        args={[
          ...
          },
          {
            ...
            type_link: "/references/types/entities#entity-specifier",
            required: [ScenarioType.EXECUTE]
          },
          {
            name: "bucket",
        ...
        outputs={[
          ...
          },
          {
            ...
            type: "Entity",
            type_link: "/references/types#entity",
          },
          {
            name: "bucket",
            description: "エンティティを入れるバケツです。",
...
`bucket` に指定するアイテムは、エンティティを格納できるバケツである必要があります（参考：1.16.5 時点では `WATER_BUCKET` のみ）。
...
<Action name="アイテムのドロップ"
        ...
        args={[
          ...
          },
          {
            ...
            type: "EntityItem",
            type_link: "/references/types#entity-item",
          }
        ]}
        outputs={[
          {
...
+ アクション実行シナリオでは、ドロップしたアイテムの [`ItemStack`](/references/types/inventory-items/#item-stack) が出力されます。
+ 実行期待シナリオでは、ドロップしたアイテムの [`EntityItem`](/references/types/entities#entity-item) が出力されます。
:::
...
この型は[こちら](/references/types#item-stack)を参照してください。
...
<Action name="プレイヤのエンティティの相互作用"
        ...
        args={[
          ...
          },
          {
            name: "entity",
            type: "EntitySpecifier",
            type_anchor: "/references/types/entities#entity-specifier",
        ...
        outputs={[
          ...
          },
          {
            name: "entity",
            type: "Entity",
            type_link: "/references/types/entities#entity",
            description: "クリックした対象のエンティティです。",
          },
          {
            name: "hand",
...
<BelowDocument docId="types/misc"
               anchor="block"
               label="Block 型"
/>
...
<Action name="プレイヤのエンティティのクリック"
        ...
        args={[
          ...
          },
          {
            ...
            type_link: "/references/types/entities#hand",
            description: "クリックする手です。",
            default: "MAIN_HAND(on execute action)"
          }
        ]}
        outputs={[
          {
...
<Action name="プレイヤの投げ物の発射"
        ...
        outputs={[
          ...
          },
          {
            ...
            type: "Projectile",
            type_link: "/references/types/entities#projectile",
          }
        ]}
        executable watchable
/>
...
|       `ITEM`        | アイテム       |                               |
|     `FIREWORK`      | 花火         | Minecraft `1.16` 以降でのみ使用できます。 |
|      `TRIDENT`      | トライデント     |                               |
