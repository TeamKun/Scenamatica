...
対象となった人間エンティティの [`HumanEntity`](/references/types/entities/#player) です。
...
<Action name="インベントリのクリック"
        ...
        args={[
          ...
          },
          {
            name: "type",
            type: "ClickType",
            type_link: "/references/types/inventory-items#inventory-click-type",
          ...
          },
          {
            name: "slotType",
            type: "SlotType",
            type_link: "/references/types#type-slot-type",
