...
対象のエンティティを[EntitySpecifier 型（エンティティ指定子）](/references/types/entities#entity-specifier)で指定します。

:::danger

セレクタを [Entity 型](/references/types/entities#entity) のオブジェクトを指定する場合は、
...
対象となったエンティティの[`Entity`](/references/types/entities#entity) オブジェクトを出力します。
...
<Action name="エンティティのダメージ"
        ...
        args={[
          ...
          },
          {
            ...
            type_link: "/references/types/entities#damage-modifier",
...
<Action name="エンティティによるアイテムのドロップ"
        ...
        args={[
          ...
          },
          {
            ...
            type_link: "/references/types/entities#entity-item",
            description: "ドロップするアイテムです。",
            required: [ScenarioType.EXECUTE]
          }
        ]}
...
アクション実行シナリオの場合でも, [アイテムの構造体](/references/types#entity-item)またはエンティティのセレクタを指定できます。
...
<Action name="エンティティの設置"
        ...
        args={[
          ...
          },
          {
            ...
            type_link: "/references/types#block-face",
...
アクション実行シナリオの場合は、この項目および [`Block#location`](/references/types/misc#location) は必須です。
