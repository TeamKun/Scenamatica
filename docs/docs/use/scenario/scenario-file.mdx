...
シナリオファイルの記述例は[こちら](https://github.com/TeamKun/Scenamatica/tree/main/Scenamatica/ScenamaticaActions/Base_v1_13_2/src/main/resources/scenarios/actions)
を参照してください。
...
例外として, アクションの名前が挙げられます。これらは, `snake_case` で定義されます。
