...
### \[[シナリオ](/docs/expressions#scenario)] [シナリオ](/docs/expressions#scenario)の設定 {#scenario}

[シナリオ](/docs/expressions#scenario)の実行に関する設定を行います。
...
### \[[アクター](/docs/expressions#actor)] [アクター](/docs/expressions#actor)の設定 {#actor}

[シナリオ](/docs/expressions#scenario)の[アクター](/docs/expressions#actor)に関する設定を行います。

#### `actor`.`maxActors` {#actor-maxActors}

同時に実行できる[アクター](/docs/expressions#actor)の最大数を設定します。
この設定はサーバ全体に適用されます。
...
[アクター](/docs/expressions#actor)のデフォルトの OP 権限を設定します。
...
[アクター](/docs/expressions#actor)に与える権限を設定します。
...
[アクター](/docs/expressions#actor)に与えるスコアボードタグを設定します。
