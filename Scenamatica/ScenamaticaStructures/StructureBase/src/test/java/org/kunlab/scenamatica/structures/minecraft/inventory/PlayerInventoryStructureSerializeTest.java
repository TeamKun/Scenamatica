...
public class PlayerInventoryStructureSerializeTest
{
    ...
    void 正常シリアライズできるか()
    {
        Map<String, Object> actual = PlayerInventoryStructureImpl.serializePlayerInventory(FULFILLED, StructureSerializerMock.getInstance());
    ...
    void 正常デシリアライズできるか()
    {
        PlayerInventoryStructure actual = PlayerInventoryStructureImpl.deserializePlayerInventory(FULFILLED_MAP, StructureSerializerMock.getInstance());
    ...
    {
        Map<String, Object> actual = PlayerInventoryStructureImpl.serializePlayerInventory(EMPTY, StructureSerializerMock.getInstance());
    ...
    {
        PlayerInventoryStructure actual = PlayerInventoryStructureImpl.deserializePlayerInventory(EMPTY_MAP, StructureSerializerMock.getInstance());
    ...
    void 防具の数がおかしい場合はエラーか()
    {
        ...
        Assertions.assertThrows(
                ...
                () -> PlayerInventoryStructureImpl.deserializePlayerInventory(map, StructureSerializerMock.getInstance())
        );
