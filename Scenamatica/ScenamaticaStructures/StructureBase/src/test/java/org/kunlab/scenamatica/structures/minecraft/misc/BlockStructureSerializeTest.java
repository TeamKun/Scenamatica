...
public class BlockStructureSerializeTest
{
    ...
    void 正常にシリアライズできるか()
    {
        Map<String, Object> map = BlockStructureImpl.serialize(FULFILLED, StructureSerializerMock.getInstance());
    ...
    void 正常にデシリアライズできるか()
    {
        BlockStructure structure = BlockStructureImpl.deserialize(FULFILLED_MAP, StructureSerializerMock.getInstance());
    ...
    {
        Map<String, Object> map = BlockStructureImpl.serialize(EMPTY, StructureSerializerMock.getInstance());
    ...
    {
        BlockStructure structure = BlockStructureImpl.deserialize(EMPTY_MAP, StructureSerializerMock.getInstance());
