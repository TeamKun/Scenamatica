...
public class NMSPersistentEntitySectionManagerImpl<E extends org.bukkit.entity.Entity> implements NMSPersistentEntitySectionManager<E>
{
    ...
    static
    {
        try
        {
            mStartTracking = PersistentEntitySectionManager.class.getDeclaredMethod("c", EntityAccess.class);
            mStartTicking = PersistentEntitySectionManager.class.getDeclaredMethod("e", EntityAccess.class);
