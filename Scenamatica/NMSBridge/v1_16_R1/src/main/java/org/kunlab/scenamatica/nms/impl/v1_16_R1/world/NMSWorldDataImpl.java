...
import net.minecraft.server.v1_16_R1.SecondaryWorldData;
...
{
    private static final Field fA;  // Lnet/minecraft/server/v1_16_R1/SecondaryWorldData; -> a#Lnet/minecraft/server/v1_16_R1/SaveData;
