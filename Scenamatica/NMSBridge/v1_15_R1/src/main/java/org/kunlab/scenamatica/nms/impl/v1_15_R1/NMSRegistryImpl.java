...
import org.kunlab.scenamatica.nms.impl.v1_15_R1.item.NMSItemImpl;
...
public class NMSRegistryImpl implements NMSRegistry
{
    ...
    public static NMSItem getItemByNMS$(final Object nms)
    {
        if (nms == null)
            ...
            throw new IllegalArgumentException("nms must be an instance of net.minecraft.server.v1_15_R1.Item");
