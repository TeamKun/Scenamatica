...
import org.kunlab.scenamatica.context.actor.nms.v1_16_R1.packets.MockedPacketPlayInSetCreativeSlot;
...
class MockedPlayer extends EntityPlayer implements Actor
{
    ...
    {
        net.minecraft.server.v1_16_R1.ItemStack nmsTack = CraftItemStack.asNMSCopy(stack);
