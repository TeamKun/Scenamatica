...
import org.kunlab.scenamatica.context.actor.nms.v1_13_R2.packets.MockedPacketPlayInSetCreativeSlot;
...
class MockedPlayer extends EntityPlayer implements Actor
{
    ...
    {
        net.minecraft.server.v1_13_R2.ItemStack nmsTack = CraftItemStack.asNMSCopy(stack);
