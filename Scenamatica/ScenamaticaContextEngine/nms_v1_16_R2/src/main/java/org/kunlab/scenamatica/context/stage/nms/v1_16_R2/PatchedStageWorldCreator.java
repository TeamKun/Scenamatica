package org.kunlab.scenamatica.context.stage.nms.v1_16_R2;
...
public class PatchedStageWorldCreator implements StageWorldCreator
{
    ...
    private static WorldServer createWorldServer(WorldCreator creator) throws StageCreateFailedException
    {
        ...
        ResourceKey<net.minecraft.server.v1_16_R2.World> worldKey = getWorldKey(name);
    ...
    private static ResourceKey<net.minecraft.server.v1_16_R2.World> getWorldKey(String worldName)
    {
