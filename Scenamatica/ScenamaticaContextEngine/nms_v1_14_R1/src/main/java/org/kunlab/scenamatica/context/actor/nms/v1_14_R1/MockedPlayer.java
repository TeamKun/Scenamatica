...
import org.kunlab.scenamatica.context.actor.nms.v1_14_R1.packets.MockedPacketPlayInSetCreativeSlot;
...
class MockedPlayer extends EntityPlayer implements Actor
{
    ...
    public void placeItem(@NotNull Location location, @NotNull ItemStack item, @Nullable BlockFace face)
    {
        ...
        ItemActionContext ctx = new MockedItemActionContext(
                /* player: */ this,
                /* enumHand: */ HAND,
                /* itemStack: */ nmsItem,
    ...
    {
        net.minecraft.server.v1_14_R1.ItemStack nmsTack = CraftItemStack.asNMSCopy(stack);
